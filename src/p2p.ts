import { Instrumentation, Span } from '@txrx/otel-instrumentation';
import { Propagation } from '@txrx/otel-instrumentation';
import { Consumer } from '@txrx/redis-consumer';
import { ConsumeItem, Consumable } from '@txrx/redis-consumer';
...
export default class P2P {
    ...
    public subscribe(fn: (_:P2PMapping) => Promise<void>): Subscription {
